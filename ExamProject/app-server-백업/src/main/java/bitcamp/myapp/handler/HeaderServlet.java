...
public class HeaderServlet extends HttpServlet {
  ...
  protected void service(HttpServletRequest request, HttpServletResponse response)
    ...
    out.println("<div style='height: 80px;background-color:orange;'>");
    out.println("<img src='https://www.ncloud.com/public/img/logo-m.png' style='height:50px'>'");
    out.println("<br>");
    ...
    if (loginUser == null) {
      ...
      out.printf("%s %s <a href='/auth/form'>로그아웃</a>\n",
