    ...
    <table border='1'>
        <tr>
            ...
            <td style='width:300px;'>
                ...
                %>
                <a href='https://kr.object.ncloudstorage.com/bitcamp-nc7-bucket-22/member/<%= member.getPhoto() %>'>
                    <img src='http://itceodfhklmc19010708.cdn.ntruss.com/member/<%= member.getPhoto() %>?type=f&w=60&h=80&faceopt=true&ttype=jpg'>
                </a>
                <%
                    }
                %>
