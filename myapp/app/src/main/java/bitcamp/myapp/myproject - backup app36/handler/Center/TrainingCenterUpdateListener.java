...
public class TrainingCenterUpdateListener implements ActionListener {

  CenterDao centerDao;

  private String temp = "";

  public TrainingCenterUpdateListener(CenterDao centerDao) {
  ...
  public void service(BreadcrumbPrompt prompt) {
    ...
    switch (changeNo) {
      ...
      case 4:
        ...
        center.setDuration(prompt.inputInt("기간(%d)? ", center.getDuration()));
