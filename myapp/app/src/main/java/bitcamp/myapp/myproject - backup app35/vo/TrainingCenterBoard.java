...
public class TrainingCenterBoard implements Serializable, CsvObject, AutoIncrement {
  ...
  public void updateKey() {
    if (TrainingCenterBoard.boardNo <= this.no) {
      TrainingCenterBoard.boardNo = this.no + 1;
    }
  }
